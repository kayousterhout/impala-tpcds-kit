...
/root/ephemeral-hdfs/bin/hadoop dfs -mkdir ${FLATFILE_HDFS_ROOT}
...
do 
  ...
  /root/ephemeral-hdfs/bin/hadoop dfs -mkdir ${FLATFILE_HDFS_ROOT}/${t}
done

echo "HDFS directories:"
/root/ephemeral-hdfs/bin/hadoop dfs -ls ${FLATFILE_HDFS_ROOT}
